...
<body>
	<form method="POST" action="payment.php?a=update" align="center">
	<table width="100%" class="css">
		<tr>
			<td><h2 align="left">EDIT PAYMENT</h2></td>
		...
		<?php $statusOptions = [1=>"Active" , 2=>"Inactive"];?>
		 <tr>
			...
			<td>
				...
				<option value="<?php echo $value;?>" <?php if ($payment['status']==$value)echo "selected";?>>
		...
		<tr>
			...
			<td>
				...
				<option value="<?php echo $value;?>" <?php if ($payment['payment_method']==$value)echo "selected";?>>
					<?php echo $label;?></option>
				<?php endforeach; ?>
			</select></td>
		</tr>
